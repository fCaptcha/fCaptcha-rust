...
pub async fn generate_headers(capi_version: &str, api_url: &str, headers_in: &BrowserHeaders) -> DortCapResult<HeaderMap> {
    ...
    headers.insert("Referer", HeaderValue::try_from("https://roblox-api.arkoselabs.com/v2/2.6.1/enforcement.bf6c920f19fb49ce16c82aaef4b83f45.html")?);
